    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground w-[--sidebar-width] max-w-none border-r-0 p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    <>
      ...
      <div
        ref={ref}
        className={cn(
          "bg-sidebar text-sidebar-foreground fixed inset-y-0 z-10 flex h-svh w-72 flex-col",
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <Button
          ...
          variant="ghost"
          size="icon"
          className={cn("text-muted-foreground hover:text-foreground h-8 w-8 rounded-lg", className)}
          onClick={event => {
            onClick?.(event);
            toggleSidebar();
          }}
