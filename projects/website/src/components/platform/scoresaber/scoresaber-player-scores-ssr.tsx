...
const SORT_OPTIONS: SortOption<ScoreSaberScoreSortField>[] = [
  {
    name: "PP",
    value: "pp",
...
export default function ScoreSaberPlayerScoresSSR({ player }: { player: ScoreSaberPlayer }) {
  ...
  const query = usePlayerScoresQuery<ScoreSaberScoreSortField, PlayerScoresPageResponse>({
    queryKeyPrefix: "playerScores:ssr",
    playerId: player.id,
