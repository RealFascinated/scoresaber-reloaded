...
export default function Navbar() {
  ...
  return (
    <nav
      className={cn(
        "sticky inset-x-0 top-0 w-full px-2 xs:px-5 py-1 flex justify-between lg:justify-around items-center backdrop-blur-md border-b border-muted select-none z-50",
