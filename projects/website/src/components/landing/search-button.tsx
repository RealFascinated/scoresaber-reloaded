...
export function SearchButton() {
  ...
  return (
    <Button
      onClick={openSearch}
      size="lg"
      className="group from-primary to-accent-secondary relative h-12 overflow-hidden rounded-xl bg-linear-to-r px-8 text-white shadow-lg transition-all duration-300 hover:shadow-xl"
    >
