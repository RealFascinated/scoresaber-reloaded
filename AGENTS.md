...
- **Schemas (TypeBox)**: **All** validation schemas belong under `projects/common/src/schemas/` (organized by domain like the rest of the tree), built with `@sinclair/typebox`. Backend and website import from `@ssr/common`; do not define duplicate or ad-hoc schemas outside `projects/common/src/schemas/`.
- **Build**:
